...
if __name__ == '__main__':
    ...
    if args.pretrain_weights != "":
        assert os.path.exists(args.pretrain_weights), "weights file: '{}' not exist.".format(args.pretrain_weights)
        weights_dict = torch.load(args.pretrain_weights)
        # 删除不需要的权重

...
def set_args():
    parser = argparse.ArgumentParser('--vit进行图片分类')
    ...
    parser.add_argument('--pretrain_weights', type=str, default='./pretrain_weights/jx_vit_base_patch16_224_in21k-e5005f0a.pth',
